...
BLADE,
        ...
        [
            ...
            'code' => <<<'BLADE'
<x-dropdown-menu>
    <x-dropdown-menu-trigger><x-button variant="bordered">상태</x-button></x-dropdown-menu-trigger>
    <x-dropdown-menu-content>
...
BLADE,
        ...
        [
            ...
            'code' => <<<'BLADE'
<x-dropdown-menu>
    <x-dropdown-menu-trigger><x-button variant="bordered">보기</x-button></x-dropdown-menu-trigger>
    <x-dropdown-menu-content>
...
BLADE,
        ...
        [
            ...
            'code' => <<<'BLADE'
<x-dropdown-menu>
    <x-dropdown-menu-trigger><x-button variant="bordered">공유</x-button></x-dropdown-menu-trigger>
    <x-dropdown-menu-content>
        <x-dropdown-menu-sub>
