...
<x-input-otp name="invalid_code" invalid />
<x-input-otp name="disabled_code" value="123456" disabled />
```
...
<x-input-otp name="invite_code" value="A2C4E6" :maxlength="6" alphanumeric />
```
