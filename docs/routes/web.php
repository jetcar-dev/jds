...
$buildComponentDocs = static function (): array {
    $propertyDescriptions = [
        ...
        'backdropVariant' => '배경 효과를 opaque, blur, transparent 중에서 선택합니다.',
        ...
        'color' => '컴포넌트의 사용자 지정 색상을 지정합니다.',
        'colorForeground' => '사용자 지정 배경 위의 전경색을 지정합니다.',
        ...
        'mode' => 'single 또는 range 선택 모드를 지정합니다.',
        ...
        'outOfRange' => '범위 밖 날짜를 disable 또는 flag로 처리합니다.',
        ...
        'size' => '컴포넌트 크기 variant를 지정합니다.',
        'src' => '표시할 이미지 주소입니다.',
        'startMonth' => '달력 탐색이 가능한 첫 월입니다.',
        'endMonth' => '달력 탐색이 가능한 마지막 월입니다.',
        'timeVariant' => '시간 입력 UI variant를 지정합니다.',
        ...
        'variant' => '시각적 스타일 variant를 지정합니다.',
        'weekStart' => '주의 시작 요일을 0~6 또는 요일 이름으로 지정합니다.',
