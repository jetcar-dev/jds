@props(['name' => null, 'value' => null, 'inputType' => 'input', 'hourCycle' => 'auto', 'seconds' => false, 'minuteStep' => 1, 'secondStep' => 1, 'min' => null, 'max' => null, 'disabled' => false, 'id' => null, 'part' => null, 'fullWidth' => false])
@php
...
@endphp
<div data-slot="time-field" data-time-config='@json($config)' @if($id) id="{{ $id }}" @endif {{ $attributes->class(['app-time-field', 'app-time-field-full' => $fullWidth]) }}>
