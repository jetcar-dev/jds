(function (window) {
    ...
    window.AppUI.register('input-mask', '[data-slot="input"][data-mask]', function (input) {
        // 9는 숫자, a는 문자, *는 영문과 숫자를 받고 나머지는 구분자로 사용
        const applyMask = function () {
            ...
            for (let maskIndex = 0; maskIndex < mask.length; maskIndex++) {
                ...
                const isRule = maskCharacter === '9' || maskCharacter === 'a' || maskCharacter === '*'
